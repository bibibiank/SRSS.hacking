...
encontramos la primera parte en el page source
```bash
<!doctype html>
<html>
  <head>
...
la segunda parte de la bandera, la em¿ncontramos en el editor de estilo, en mycss.css
```bash 
...
la tercera parte de la bandera la encontramos en el inspector, en debugger
```bash
