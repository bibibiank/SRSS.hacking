...
- en el buscador ingresamos lo siguiente
```shell
...
-ahora ingresamos a la carpeta hidden
```shell
...
- ahora nos vamos a la carpeta llamada `superhidden` que nos debe dar la bandera
...
<html>
  <head>
    <title></title>
    <link rel="stylesheet" href="[mycss.css](view-source:http://saturn.picoctf.net:63693/secret/hidden/superhidden/mycss.css)" />
  </head>
