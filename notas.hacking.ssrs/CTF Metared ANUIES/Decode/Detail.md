...
┌──(armando㉿kali)-[~/ctfAnuies]

└─$ unzip Ciberseguridad.pptx

Archive:  Ciberseguridad.pptx

  inflating: docProps/custom.xml    

  inflating: ppt/_rels/presentation.xml.rels  

  inflating: ppt/media/file.png      

  inflating: ppt/media/image1.png    

  inflating: ppt/media/image10.jpeg  

  inflating: ppt/media/image11.png  

  inflating: ppt/media/image12.png  

  inflating: ppt/media/image2.png    

  inflating: ppt/media/image3.jpeg  

  inflating: ppt/media/image4.jpeg  

  inflating: ppt/media/image5.jpeg  

  inflating: ppt/media/image6.png    

  inflating: ppt/media/image7.jpeg  

  inflating: ppt/media/image8.png    

  inflating: ppt/media/image9.png    
...
┌──(armando㉿kali)-[~/ctfAnuies/ppt/media]

└─$ file file.png              

file.png: ASCII text, with very long lines (65536), with no line terminators

┌──(armando㉿kali)-[~/ctfAnuies/ppt/media]

└─$ cat file.png | base64 -d > imagen_decodificada.png

  

┌──(armando㉿kali)-[~/ctfAnuies/ppt/media]

└─$ eog imagen_decodificada.png    

  
  

```
![[Imagen de WhatsApp 2024-10-16 a las 12.28.04_4e37daea.jpg]]
