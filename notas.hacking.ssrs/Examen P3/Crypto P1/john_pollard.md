...
```java
┌──(kali㉿kali)-[~/Downloads/crypto/john_pollard]
└─$ ls
cert
...
con  [FactorDB](https://factordb.com/) obtenemos la factorización del valor del Modulo que obtenemos al inspeccionar el archivo
